...
import { lang } from '../settings/constants/lang';
...
export const navLinks = [
    {
        ...
        name: lang.ar.links.manageUsers, icon: <PersonAddAltIcon />, to: "/management/users/user", allowedTo: [user_roles.SUBADMIN, user_roles.ADMIN],
    }, {
